...
public class ExpandableListLugarVisitaAdapter extends BaseExpandableListAdapter{
	...
	public ExpandableListLugarVisitaAdapter(Context context, List<String> listDataHeader,
	...
	public View getChildView(int groupPosition, final int childPosition,
		...
		if (convertView == null) {
			...
			convertView = infalInflater.inflate(R.layout.listrow_lugarvisita_details, null);
		}
